...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2016 at 09:58 PM
...
CREATE TABLE `review` (
  `reviesid` int(6) NOT NULL,
  `reviewname` varchar(30) COLLATE utf8_estonian_ci NOT NULL,
  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `detail` varchar(1000) COLLATE utf8_estonian_ci NOT NULL,
...
--
ALTER TABLE `review`
  MODIFY `reviesid` int(6) NOT NULL AUTO_INCREMENT;
